...
public class TestAll extends TestCase {
    ...
    public static Test suite() {
        ...
        suite.addTest(TestFieldUtils_2.suite());
        suite.addTest(TestBaseDateTimeField.suite());
        suite.addTest(TestBaseDateTimeField_1.suite());

        suite.addTest(TestOffsetDateTimeField.suite());
        suite.addTest(TestOffsetDateTimeField_2.suite());
        suite.addTest(TestOffsetDateTimeField_3.suite());
